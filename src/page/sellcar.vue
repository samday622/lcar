      ...
      <div class="sell-list">
        <el-form ref="form" :model="form" label-width="60px">
          <el-form-item label="品牌" prop="brandName">
            <el-select v-model="brandName" placeholder="请选择" @change="changeBrand">
              <el-option
          ...
          <el-form-item label="车系" prop="seriesName">
            <el-select v-model="seriesName" placeholder="请选择" @change="changeBrand">
              <el-option
          ...
          <div class="sell-btn-wrap">
            <a href="javascript:void(0)" class="sell-car-btn" onclick="submitForm('ruleForm')">免费买车</a>
          </div>
        </el-form>
      </div>
  </div>
