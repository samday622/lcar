<template>
  <div class="sell-wrap lc-title">
    <div class="title">
      <span @click="goHistory"></span>我要卖车
    </div>
      <div class="sell-list">
        <el-form :model="sellForm" :rules="rules" ref="sellForm" label-width="60px">
          <el-form-item label="品牌" prop="brandName">
            <el-select v-model="sellForm.brandName" placeholder="请选择" @change="changeBrand">
              <el-option
          ...
          <el-form-item label="车系" prop="seriesName">
            <el-select v-model="sellForm.seriesName" placeholder="请选择" @change="changeBrand">
              <el-option
          ...
          <el-form-item label="姓名" prop="name">
            <el-input v-model="sellForm.name" placeholder="请输入姓名"></el-input>
          </el-form-item>
          <el-form-item label="手机" prop="phone">
            <el-input v-model="sellForm.phone" placeholder="请输入手机"></el-input>
          </el-form-item>
          <div class="sell-btn-wrap">
            <a href="javascript:void(0)" class="sell-car-btn" @click="submitForm('sellForm')">免费买车</a>
          </div>
        </el-form>
      </div>
  </div>
